...
<testsuite name="Luacheck report" tests="8" failures="5" errors="2">
   <testcase name="bad_file" classname="bad_file" file="bad_file">
      <error type="I/O error" message="couldn't read: No such file or directory"/>
   </testcase>
   <testcase name="spec/samples/good_code.lua" classname="spec/samples/good_code.lua" file="spec/samples/good_code.lua"/>
   <testcase name="spec/samples/bad_code.lua:3:16" classname="spec/samples/bad_code.lua" file="spec/samples/bad_code.lua" line="3" column="16">
      <failure type="W211" message="spec/samples/bad_code.lua:3:16: unused function &apos;helper&apos;">spec/samples/bad_code.lua:3:16: unused function &apos;helper&apos;</failure>
   </testcase>
   <testcase name="spec/samples/bad_code.lua:3:23" classname="spec/samples/bad_code.lua" file="spec/samples/bad_code.lua" line="3" column="23">
      <failure type="W212" message="spec/samples/bad_code.lua:3:23: unused variable length argument">spec/samples/bad_code.lua:3:23: unused variable length argument</failure>
   </testcase>
   <testcase name="spec/samples/bad_code.lua:7:10" classname="spec/samples/bad_code.lua" file="spec/samples/bad_code.lua" line="7" column="10">
      <failure type="W111" message="spec/samples/bad_code.lua:7:10: setting non-standard global variable &apos;embrace&apos;">spec/samples/bad_code.lua:7:10: setting non-standard global variable &apos;embrace&apos;</failure>
   </testcase>
   <testcase name="spec/samples/bad_code.lua:8:10" classname="spec/samples/bad_code.lua" file="spec/samples/bad_code.lua" line="8" column="10">
      <failure type="W412" message="spec/samples/bad_code.lua:8:10: variable &apos;opt&apos; was previously defined as an argument on line 7">spec/samples/bad_code.lua:8:10: variable &apos;opt&apos; was previously defined as an argument on line 7</failure>
   </testcase>
   <testcase name="spec/samples/bad_code.lua:9:11" classname="spec/samples/bad_code.lua" file="spec/samples/bad_code.lua" line="9" column="11">
      <failure type="W113" message="spec/samples/bad_code.lua:9:11: accessing undefined variable &apos;hepler&apos;">spec/samples/bad_code.lua:9:11: accessing undefined variable &apos;hepler&apos;</failure>
   </testcase>
   <testcase name="spec/samples/python_code.lua:1:6" classname="spec/samples/python_code.lua" file="spec/samples/python_code.lua" line="1" column="6">
      <error type="E011" message="spec/samples/python_code.lua:1:6: expected &apos;=&apos; near &apos;__future__&apos;">spec/samples/python_code.lua:1:6: expected &apos;=&apos; near &apos;__future__&apos;</error>
   </testcase>
</testsuite>
